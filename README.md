...
Dataset DOI: https://doi.org/10.5281/zenodo.19112625
...
Data preprocessing  
Fourth-corner analysis (with fixed random seed for reproducibility)  
Trait–environment visualization  
________________________________________
Output (output/)  
Results.csv  
Output of the fourth-corner analysis  
Included for convenience; fully reproducible using the provided script  
________________________________________
Figures (figures/)  
TraitWheel.png  
Circular visualization of significant trait–environment associations  
________________________________________
Reproducibility  
Workflow  
...
________________________________________
License
This dataset is released under a Creative Commons Attribution 4.0 International License (CC-BY 4.0).
